...
bool KPhaseSpace::IsAboveThreshold(void) const
{
  ...
  if (pi.IsCoherent()       || 
      ...
      pi.IsMEC()            || 
      pi.IsGlashowResonanceAtomic() || 
      pi.IsGlashowResonanceInel() || 
      pi.IsGlashowResonanceCoh()) 
  {
