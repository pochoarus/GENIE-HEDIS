...
#ifndef _GLASHOW_RESONANCE_COH_XSEC_H_
#define _GLASHOW_RESONANCE_COH_XSEC_H_
...
class GLRESCohXSec : public XSecIntegratorI {

public:
  GLRESCohXSec();
  GLRESCohXSec(string config);
  virtual ~GLRESCohXSec();
...
#endif  // _GLASHOW_RESONANCE_COH_XSEC_H_
