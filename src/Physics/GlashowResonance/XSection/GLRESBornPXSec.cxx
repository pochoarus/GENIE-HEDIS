...
//____________________________________________________________________________
double GLRESBornPXSec::PXSecCC(double s, double t, double mlin2, double mlout2)
{
...
//____________________________________________________________________________
double GLRESBornPXSec::PXSecCCNC(double s, double t, double mlin2, double mlout2)
{
...
//____________________________________________________________________________
double GLRESBornPXSec::PXSecLepton(double s, double t, int nu, int lp, double mlin2, double mlout2)
{

  double ME = 0.;
  if ( TMath::Abs(lp)+1 == TMath::Abs(nu) ) ME = PXSecCCNC(s,t,mlin2,mlout2);
  else                                      ME = PXSecCC  (s,t,mlin2,mlout2); 
  return TMath::Max(0.,ME);

}
//____________________________________________________________________________
double GLRESBornPXSec::PXSecPhoton(double s, double t, double mlout2)
{
...
//____________________________________________________________________________
double GLRESBornPXSec::PXSecPhoton_T(double s12, double s13, double Q2, double ml2){
  double ME2 = 0.0;
...
//____________________________________________________________________________
double GLRESBornPXSec::PXSecPhoton_L(double s12, double s13, double Q2, double ml2){
  double ME2 = 0.0;
...
//____________________________________________________________________________
double GLRESBornPXSec::Lambda(double a, double b, double c)
{
  return a*a + b*b + c*c - 2*a*b - 2*a*c - 2*b*c;
}
//____________________________________________________________________________
double GLRESBornPXSec::GetT(double m1, double m2, double m3, double m4, double s, double costh)
{
